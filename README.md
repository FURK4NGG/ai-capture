...
<details>
<summary>?</summary>
      OpenRouter: Provides access to online AI models through a single API.*Some models may require paid usage depending on the provider.*<br><br>
